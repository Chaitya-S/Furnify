...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <p className="text-[#a77979] text-6xl content-center text-center justify-center mt-4 mb-8 w-4/5">
        'A <span className="text-[#6d2932]">revolutionary</span> online
        <span className="text-[#6d2932]">3D</span> experience furniture store.'
      </p>
      <Carousel images={images} />
      <p className="text-black text-6xl content-center text-center justify-center my-8 w-4/5">
        Designed by us....
      </p>
    </main>
  );
